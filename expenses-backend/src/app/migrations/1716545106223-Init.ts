...
export class Init1716545106223 implements MigrationInterface {
  name = 'Init1716545106223';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "expense_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "amount" integer NOT NULL, "category" "public"."expense_entity_category_enum" NOT NULL DEFAULT 'misc', "notes" character varying, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" uuid, "recurringExpenseId" uuid, CONSTRAINT "PK_925dcb90c5f37e7ee13141379fa" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."recurring_income_entity_category_enum" AS ENUM('salary')`,
    );
    await queryRunner.query(
      `CREATE TABLE "recurring_income_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "amount" integer NOT NULL, "category" "public"."recurring_income_entity_category_enum" NOT NULL DEFAULT 'salary', "notes" character varying, "cron" character varying NOT NULL, "startDate" date, "endDate" date, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" uuid, CONSTRAINT "PK_739fa03b2454d61a4ef017fc8ec" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."income_entity_category_enum" AS ENUM('salary')`,
    );
    await queryRunner.query(
      `CREATE TABLE "income_entity" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "amount" integer NOT NULL, "category" "public"."income_entity_category_enum" NOT NULL DEFAULT 'salary', "notes" character varying, "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now(), "userId" uuid, "recurringIncomeId" uuid, CONSTRAINT "PK_14a9aa8770e3b7ee0f1bf48e475" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
